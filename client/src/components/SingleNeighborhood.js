...
export default class SingleNeighborhood extends Component {
    ...
    handleSubmit = event => {
        ...
        axios.put(`/api/neighborhoods/${this.state.neighborhood._id}`)
        .then(res => {
            this.setState({
                creature: res.data,
                isEditFormDisplayed:false
    ...
    render() {
        ...
        return this.state.isEditFormDisplayed ? (
            <form onSubmit={this.handleSubmit}>
                ...
                />
                <label htmlFor='neighborhood-description'>Neighborhood Description</label>
                <input
                    type='text'
            ...
            <div>
                ...
                <button onClick={this.handleDeleteNeighborhood}>Delete Neighborhood</button>
